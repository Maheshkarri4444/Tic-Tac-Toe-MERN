...
const HomePage = () => {
  return (
    <div className='flex flex-col items-center justify-center w-full h-full gap-6'>
        <Link to='/offline' className=' cursor-pointer bg-indigo-600 text-[1.2rem] px-[25px] py-[10px] rounded-md border-none hover:bg-indigo-700  hover:px-[40px]' >Offline Mode</Link>
